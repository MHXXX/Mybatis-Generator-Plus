...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected void addUpdateByExampleSelectiveElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateUpdateByExampleSelective()) {
            AbstractXmlElementGenerator elementGenerator = new UpdateByExampleSelectiveElementWithoutAliasGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addUpdateByExampleWithBLOBsElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateUpdateByExampleWithBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new UpdateByExampleWithBLOBsElementWithoutAliasGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addUpdateByExampleWithoutBLOBsElement(
        ...
        if (introspectedTable.getRules().generateUpdateByExampleWithoutBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new UpdateByExampleWithoutBLOBsElementWithoutAliasGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
