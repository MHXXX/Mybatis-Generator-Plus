...
public class Context extends PropertyHolder {
    ...
    public void introspectTables(ProgressCallback callback,
        ...
        try {
            ...
            // add by suman start
            Map<String, IntrospectedTable> introspectedTableMap = new HashMap<String, IntrospectedTable>();
            // add by suman end
            for (TableConfiguration tc : tableConfigurations) {
                ...
                if (tables != null) {
                    ...
                    for (IntrospectedTable introspectedTable : tables) {
                        introspectedTableMap.put(introspectedTable.getFullyQualifiedTable().getIntrospectedTableName(), introspectedTable);
                    }
                    // add by suman end
                }
            ...
            for (IntrospectedTable introspectedTable : introspectedTables) {//�������еı�
                List<IntrospectedColumn> foreignKeyColumns = introspectedTable.getForeignKeyColumns();//得到所有的外键
                if(foreignKeyColumns == null || foreignKeyColumns.size() == 0) continue;//���û������� ���
                for (IntrospectedColumn foreignKeyColumn : foreignKeyColumns) {//���������
                    ...
                    IntrospectedTable importIntrospectedTable = introspectedTableMap.get(importTable.getTableName());//�õ���������
                    if(importIntrospectedTable == null){
                        System.out.println("未找到"+importTable);
                        continue;
                    }
