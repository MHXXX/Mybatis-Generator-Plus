...
public class DatabaseIntrospector {
    ...
    private Map<ActualTableName, List<IntrospectedColumn>> getColumns(
        ...
        //add by suman
        Map<ActualTableName, Map<String,ImportColumn>> importTableMap = new HashMap<>();
        ...
        while (rs.next()) {
            ...
            Map<String, ImportColumn> importColumnMap = importTableMap.computeIfAbsent(atn, k -> new HashMap<String, ImportColumn>());
